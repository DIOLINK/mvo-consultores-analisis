    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
          Análisis Técnico
          <span className="block text-blue-600 dark:text-blue-400">MVO Consultores</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white ml-3">Propuesta de Migración</h2>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white ml-3">Reporte Técnico</h2>
          </div>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white ml-3">Datos Técnicos</h2>
          </div>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-8 transition-all duration-300">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Resumen Ejecutivo</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Estado Actual</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Propuesta de Mejora</h3>
            <ul className="space-y-2 text-gray-600 dark:text-gray-300">
              <li className="flex items-start">
